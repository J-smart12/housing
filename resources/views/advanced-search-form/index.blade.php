...
<body id="myhome-app"
    class="wp-singular page-template-default page page-id-1836 wp-theme-myhome mmm mega_main_menu-2-2-1-1 myhome-body mh-hide-top-bar-on-mobile mh-active-input-primary myhome-3-1-69 essb-9.0 wpb-js-composer js-comp-ver-6.13.0 vc_responsive">
                            ...
                            <li id="menu-item-3497"
                                ...
                                <ul class="mega_dropdown">
                                    ...
                                    <li id="menu-item-3545"
                                        class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-1836 current_page_item menu-item-3545 default_dropdown  drop_to_right submenu_default_width columns1">
                                        <a href="" class="item_link  disable_icon" tabindex="5"> <i
    ...
    <div class="mh-top-title">
        <h1 class="mh-top-title__heading">Advanced Search Form</h1>
        ...
        <div id="post-1836" class="mh-post">
            <section class="wpb-content-wrapper">
                <div data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true"
                    class="vc_row wpb_row vc_row-fluid vc_custom_1485891843038 vc_row-no-padding">
                    <div class="wpb_column vc_column_container vc_col-sm-12">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper"> <listing-grid id="myhome-listing-grid" class=""
...
@section('scripts')
    <script type="text/javascript" id="myhome-min-js-extra">
        ...
        var MyHomeListing1747769080 = {
            ...
            "search_form_advanced_number": "999",
            "estates_per_page": "12",
