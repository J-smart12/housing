...
<body id="myhome-app"
    class="archive author author-admin author-1 wp-theme-myhome mmm mega_main_menu-2-2-1-1 myhome-body mh-hide-top-bar-on-mobile mh-active-input-primary myhome-3-1-69 essb-9.0 wpb-js-composer js-comp-ver-6.13.0 vc_responsive">
                        ...
                        <div class="mh-agent-contact">
                            <div class="mh-agent-contact__element">
                                <a href="mailto:admin@carmodyrealestates.com">
                                    ...
                                    admin@carmodyrealestates.com </a>
                            </div>
    ...
    <div class="mh-layout mh-top-title-offset">
        <div class="mh-listing--full-width mh-listing--horizontal-boxed">
            <listing-grid id="myhome-listing-grid" class="mh-search-left" config-key='MyHomeListing1747769191'>
            </listing-grid>
        </div>
    </div>
@endsection
