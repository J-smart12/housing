@extends('layout.main')
@section('title', 'City >> Neighborhood >> Street')

@section('body')

<body id="myhome-app" class="wp-singular page-template-default page page-id-2199 wp-theme-myhome mmm mega_main_menu-2-2-1-1 myhome-body mh-hide-top-bar-on-mobile mh-active-input-primary myhome-3-1-69 essb-9.0 wpb-js-composer js-comp-ver-6.13.0 vc_responsive">
