...
<body id="myhome-app"
    class="wp-singular page-template-default page page-id-2199 wp-theme-myhome mmm mega_main_menu-2-2-1-1 myhome-body mh-hide-top-bar-on-mobile mh-active-input-primary myhome-3-1-69 essb-9.0 wpb-js-composer js-comp-ver-6.13.0 vc_responsive">
                            ...
                            <li id="menu-item-3497"
                                ...
                                <ul class="mega_dropdown">
                                    <li id="menu-item-3550"
                                        class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2199 current_page_item menu-item-3550 default_dropdown  drop_to_right submenu_default_width columns1">
                                        <a href="" class="item_link  disable_icon" tabindex="3"> <i
                        ...
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                <div class="wpb_text_column wpb_content_element ">
                                    <div class="wpb_wrapper">
                                        <p style="text-align: center;">You can change city field value and search
                                            engine will display only correct values in the neighborhood and street
                                            fields.</p>

                                    </div>
                                </div>
                                <listing-grid id="myhome-listing-grid" class=""
                                    config-key='MyHomeListing1747769079'>
                                </listing-grid>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from carmodyrealestates.com/city-neighborhood-street/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 May 2025 19:25:50 GMT -->
