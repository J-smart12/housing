...
<body id="myhome-app" class="archive date wp-theme-myhome mmm mega_main_menu-2-2-1-1 myhome-body mh-hide-top-bar-on-mobile mh-active-input-primary myhome-3-1-69 essb-9.0 wpb-js-composer js-comp-ver-6.13.0 vc_responsive">
    ...
    <div class="mh-top-title mh-top-title--image-background lazyload" style="background-size:cover;"
        ...
        <h1 class="mh-top-title__heading">Month: <span>{{ $month }}, {{ $year }}</span></h1>
            ...
            @foreach ($posts as $post)
                <div class="mh-grid">
                    <div class="mh-grid__1of1">
                        <article id="post-{{ $post->id }}" class="mh-post-grid post-211 post type-post status-publish format-standard has-post-thumbnail hentry category-home-design tag-architecture tag-design tag-house">

                            <a href={{ url("blogs/".$post->slug) }} title={{ $post->title}}
                                class="mh-post-grid__thumbnail">
                                <div class="mh-thumbnail__inner">
                                    <img data-srcset={{ asset($post->image) }}
                            ...
                            <div class="mh-post-grid__inner">
                                ...
                                <div class="mh-post-grid__excerpt">
                                    {{ \Illuminate\Support\Str::words($post->body, 40) }}... </div>
